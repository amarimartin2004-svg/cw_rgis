...
mtcars_g35 <- mtcars[mtcars$cyl ==6,]
...
mtcars_g35 <- df_mtcars[df_mtcars$gear %>%  c(3,5),]
...
mtcars_g35 <- df_mtcars[df_mtcars$mpg > 25, ]
...
mtcars_light_cyl4 <- df_mtcars[df_mtcars$wt < 2.5 & df_mtcars$cyl == 4, ]
